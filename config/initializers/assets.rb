...
Rails.application.config.assets.precompile += %w( bbb.js )
Rails.application.config.assets.precompile += %w( bbb.css )
Rails.application.config.assets.precompile += %w( users.js )
Rails.application.config.assets.precompile += %w( users.css )
Rails.application.config.assets.precompile += %w( traditional.css )
